(()=> {
  ...
  if(!document.querySelector("#openpq-clock-style")){
    ...
    s.textContent=`
      ...
      .vn-clock>span{grid-column:1;font-size:11px;letter-spacing:.16em;font-weight:900;color:#607773}
      ...
      .vn-clock>small{grid-column:2;grid-row:1/3;align-self:center;padding-left:12px;border-left:1px solid #DCE8E5;font-size:11px;line-height:1.5;color:#607773}
      .vn-clock>small b{color:#123D3B;font-size:11px;letter-spacing:.08em;text-transform:uppercase}
      @media(max-width:760px){.vn-clock{min-height:40px;padding:6px 10px 6px 13px;border-radius:13px}.vn-clock::before{inset:8px auto 8px 0}.vn-clock>small{display:none}.vn-clock>strong{font-size:18px}.vn-clock>span{font-size:11px}}
    `;
