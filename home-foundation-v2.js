...
function ageText(iso){
  ...
  if(!Number.isFinite(t))return"Chưa có mốc cập nhật";
...
function renderNearResults(){
  ...
  if(!items.length){
    host.innerHTML='<div><strong>Chưa có điểm phù hợp đủ dữ liệu.</strong><span>Thử khu vực hoặc loại tiện ích khác.</span></div>'+
