...
for (const script of ["scripts/test-go-engine.mjs","scripts/test-home-library.mjs","scripts/test-explore-labels.mjs","scripts/build-knowledge-public.mjs","scripts/build-search-index.mjs"]) {
