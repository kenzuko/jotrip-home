...
for (const script of ["scripts/weather-context-api.test.mjs","scripts/test-weather-context-client.mjs","scripts/test-nearme-venues.mjs","scripts/test-go-engine.mjs","scripts/test-go-live-api.mjs","scripts/test-go-weather-context.mjs","scripts/test-shared-area-and-schedules.mjs","scripts/test-decision-signals.mjs","scripts/test-go-geo.mjs","scripts/test-go-manual-ui.mjs","scripts/test-home-library.mjs","scripts/test-editorial-photo-curation.mjs","scripts/test-home-hero-search.mjs","scripts/test-home-hero-gallery.mjs","scripts/test-homepage-five-chapters.mjs","scripts/validate-public-copy.mjs","scripts/test-editorial-photo-audit.mjs","scripts/test-explore-labels.mjs","scripts/build-knowledge-public.mjs","scripts/build-search-index.mjs"]) {
