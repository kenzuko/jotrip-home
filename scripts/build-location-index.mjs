...
for(const entity of entities){
  ...
  documents.push({
    ...
    operational_status:entity.operational_status||null,
    publication_status:entity.publication_status||null,
    external_verify_url:/^https:\/\//.test(entity.external_verify_url||"")?entity.external_verify_url:null,
    phone_scope:entity.phone_scope||null,
    source_license:(entity.source_refs||[]).some(x=>x.license==="ODbL-1.0")?"ODbL-1.0":null,
