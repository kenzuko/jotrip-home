...
const multiDash=dash();multiDash.points.duong_dong.hours[0].wind=31;
multiDash.points.duong_dong.hours[0].gust=46;
const all=x.islandAlerts(ctx({nowcast:sat(90,motion("MEDIUM_HIGH",8)),dashboard:multiDash}));
